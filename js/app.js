function onSignup() {
    ...
    var MobileNumber = document.getElementById("MobileNumber1");
    ...
    if (userIdx === -1 && (email.value!=0 && password.value!=0 && Address.value!=0 && Age.value!=0 && MobileNumber.value!=0 )) {
    ...
    else if(email.value===''&& password.value===''&& Address.value===''&& Age.value===''&& MobileNumber.value===''){
        message.innerHTML = "User info can't be empty";
    }
